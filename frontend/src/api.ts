...
export const api = {
    ...
    query: (body: { question: string; language: string; depth: string; search_mode: 'pure' | 'graph'; chat_model?: string; top_k: number; knn_neighbors?: number; fanout?: number; number_of_hops?: number; session_id?: string; document_ids?: string[] }) => demoMode ? Promise.resolve({
